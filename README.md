...
- **Section 3.5**: [**Diffusion Forecasts**](https://github.com/jbramburger/weighted_methods/tree/main/Diffusion%20Forecasts). This folder contains a script to produce and compare weighted and unweighted non-parametric forecasts using diffusion maps. It contains the folder "NonparametricModel" containing scripts/modules written by [Tyrus Berry](https://math.gmu.edu/~berry/) to run the general diffusion forecast method.
