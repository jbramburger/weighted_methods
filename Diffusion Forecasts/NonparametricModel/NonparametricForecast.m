function [ferr,Forecast,Truth,ForecastVar] = NonparametricForecast(trainingData,obs,truth,R,forecastSteps,delays,nvars)
...
%%% Written by Tyrus Berry of George Mason University 
    ...
    k2=22;
    shifts=1;
    [basis,ForwardOp,~,peq,qest,normalizer] = BuildModelVBDM(trainingData,k,k2,nvars,delays,shifts);
